...
import essay from '@/content/essays/pillarD.js'
...
definePageMeta({ name: 'pillarD' })
usePageSeo('pillarD')

const meta = EXPERIENCES.find((e) => e.id === 'pillarD')
...
const steps = useStepHistory(currentScreen, { id: 'pillarD' })
