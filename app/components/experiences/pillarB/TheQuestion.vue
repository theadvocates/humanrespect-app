<template>
  <div ref="el" class="screen-inner stagger">
    ...
    <ContentBlock variant="insight"><p>No major moral philosophy has put time at the center of its framework this way. The Philosophy of Human Respect does, because once you see property as crystallized time and coercion as the theft of life, every political question looks different.</p></ContentBlock>
    <NewsletterSignup variant="minimal" source="pillarB_closing" headline="One question per week, applied to the real world." description="A short email on how the force-or-persuasion question plays out in real situations." button-text="Subscribe" />
