<template>
  <div ref="el" class="screen-inner stagger">
    ...
    <p class="body-text">The disagreements are real. The stakes are real. The people who disagree with you about policy are as convinced they're right as you are. And yes, politicians persuade — they campaign, negotiate, and compromise. But every political negotiation happens in the shadow of a fact with no equivalent in your personal life: when the process ends, the result is imposed on everyone, including those who never agreed. In your relationships, when persuasion fails, you don't get your way. In politics, when persuasion fails, force takes over.</p>
