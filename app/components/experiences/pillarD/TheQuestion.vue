<template>
  <div ref="el" class="screen-inner stagger">
    ...
    <ContentBlock variant="concession" label="The honest acknowledgment"><p>This is hard. Really hard. When you care deeply about an issue, the temptation to use force is real. The philosophy asks you to trust that persuasion and cooperation will produce better outcomes — especially for the causes you care about most.</p></ContentBlock>
    <p class="body-text">People across the political spectrum disagree on values, and those disagreements are real. But beneath them lies a question that cuts deeper: will you advance your values through persuasion, or through force? That question is the one thing people of every political identity could agree on without giving up a single value they hold. It may be the only path out of the conflict.</p>
    <NewsletterSignup variant="minimal" source="pillarD_closing" headline="One question per week, applied to the real world." description="A short email on how the force-or-persuasion question plays out in real situations." button-text="Subscribe" />
