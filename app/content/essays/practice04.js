export default {
  standfirst:
    'Seven days, sixty seconds a day. Notice one moment where force and persuasion were both available, and which one you reached for. You do not have to change anything. Noticing is the whole exercise.',
  sections: [
    {
    ...
    {
      heading: 'What happens by day seven',
      body: [
